...
from forcedimension.typing import ComModeStr, c_int_ptr
...
class Status(Structure):
    ...
    def __str__(self) -> str:
        return (
            ...
            "forceoffcause={}, locks={}, axis_checked={})"
        ).format(*self)
...
class DHDErrorNotImplemented(DHDError, NotImplementedError):
    def __init__(self, op: Optional[str] = None, *args, **kwargs):
        if op is not None:
            return super().__init__(
                f"{op} is currently not implemented."
            )
