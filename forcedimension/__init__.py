...
class HapticDevice:
    ...
    def _init_max_force(self, restore: bool = False):
        ...
        max_force = dhd.getMaxForce(self._id)
        if max_force < 0:
            max_force = None
    ...
    def _init_max_torque(self, restore: bool = False):
        ...
        max_torque = dhd.getMaxTorque(self._id)
        if max_torque < 0:
            max_torque = None
    ...
    def dump_config(self, exclude_defaults: bool = False):
        ...
        return self._config.dict(exclude_defaults=exclude_defaults)
